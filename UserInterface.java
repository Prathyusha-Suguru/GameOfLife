	...
	**********************************************************************************************/
	...
	private void loadImageData() {
		try {
		    ...
		    while(sc.hasNextLine()) {
		    	String[] s=sc.nextLine().split(" ");
		    	l[idx][0]=Integer.parseInt(s[0]);
		    	l[idx][1]=Integer.parseInt(s[1]);
		    	idx++;
		    }
		    oddGameBoard.createBoard(l);
			draw(oddGameBoard,evenCanvas);
	...
	public void draw(Board board,Pane p) {
